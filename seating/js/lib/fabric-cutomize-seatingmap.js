/*customize
change002 - for rotation icon
change003 - border style
change004 - lock resize, tl tr br bl
change005 - for selection border
change006 - for XY Scaling
change007 - customize corner icon
change008 - customize fabric circle
...
imgObj.src = "images/rotate-icon.png";
fabric.rotateIcon = imgObj;

var imgResizeIcon1 = new Image();
imgResizeIcon1.src = 'images/scaling-lt.png';
var imgResizeIcon2 = new Image();
imgResizeIcon2.src = 'images/scaling-rt.png';
...
(function(global) {
  ...
  fabric.Object = fabric.util.createClass(/** @lends fabric.Object.prototype */ {
     ...
     * @default
     */
    rotatingPointOffset:      35, //40, //change002
    ...
    lock4Scaling:             false,  //change004 - lock resize
    ...
    //change008
    nindex: -2, //-2:rows, -1 : main, 0,1,... : normal
    nrow: 0, 
    ncol: 0,
    isDeleted : false,
    isSeating : false,
    ...
    objtype : 'none', //textobj, objects, square, tcircle, sections, tsquare
...
(function() {
  ...
  fabric.util.object.extend(fabric.Object.prototype, /** @lends fabric.Object.prototype */ {
    ...
    drawBorders: function(ctx) {
      ...
      ctx.setLineDash([4,4]);//change003 - border style
      ...
      //change005 - for section border
      var vpt = this.getViewportTransform();
      var tmpltpaddding = fabric.util.transformPoint({x: this.get('lpadding'), y: this.get('tpadding')}, vpt);
      var tmprbpaddding = fabric.util.transformPoint({x: this.get('rpadding'), y: this.get('bpadding')}, vpt);
      ctx.strokeRect(
        -width / 2 - tmpltpaddding.x, 
        -height / 2 - tmpltpaddding.y,
        width + tmpltpaddding.x + tmprbpaddding.x,
        height + tmpltpaddding.y + tmprbpaddding.y
      );
      ...
      if (this.hasRotatingPoint && this.isControlVisible('mtr') && !this.get('lockRotation') && this.hasControls) {
        ...
        ctx.moveTo(0, rotateHeight - tmpltpaddding.y - tmprbpaddding.y);
        ctx.lineTo(0, rotateHeight - this.rotatingPointOffset);

        //ctx.closePath();  //change003
        ctx.stroke();
      }
    ...
    _drawControl: function(control, ctx, methodName, left, top) {
      ...
      switch (this.cornerStyle) {
        case 'circle':
          ...
          //change002
          if(control == "mtr") {
            if(!this.get('lockRotation')) ctx.drawImage(fabric.rotateIcon, left, top);
          }
          else {
        ...
        default:
          ...
          if(control == "mtr") {
            ...
            {
            case 'tl':            
                SelectedIconImage = imgResizeIcon1;
                //SelectedIconImage.src = 'images/scaling-lt.png';
                break;
            case 'tr':
                //SelectedIconImage.src = 'images/scaling-rt.png';
                SelectedIconImage = imgResizeIcon2;
                break;
            case 'bl':
                SelectedIconImage = imgResizeIcon2;
                break;
            ...
            ctx.drawImage(SelectedIconImage, left, top);
          }
      }
    },
    ...
    _getControlsVisibility: function() {
      if (!this._controlsVisibility) {
        if(this.get('lock4Scaling')) { //change004
